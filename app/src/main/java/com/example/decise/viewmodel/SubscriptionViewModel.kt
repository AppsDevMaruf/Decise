...
class SubscriptionViewModel @Inject constructor(
    ...
    private var _responseGetSubscriptionList = MutableLiveData<NetworkResult<ResponseSubscriptionsList>>()
    val getSubscriptionListVMLD: LiveData<NetworkResult<ResponseSubscriptionsList>> = _responseGetSubscriptionList
